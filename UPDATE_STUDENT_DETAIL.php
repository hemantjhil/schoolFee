...
if (isset($_GET["login"])){
	...
	$studentUpdateQuery="UPDATE `student_detail` SET `name`='$name',`aadhaar`='$aadhaar',`father_name`='$father_name',`mother_name`='$mother_name',`address`='$address',`mob1`='$mobile',`active`='$active',`enrolled_in_year`='$enrolled_in_year',`enrolled_out_year`='$enrolled_out_year',`previous_attended_school`='$previous_attended_school',`notes`='$notes' WHERE admno = '$admno' ";
