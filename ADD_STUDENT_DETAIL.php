...
if (isset($_GET["login"])){
	...
	$studentUpdateQuery="INSERT INTO `student_detail`(`admno`, `name`, `email_id`, `aadhaar`, `father_name`, `mother_name`, `address`, `mob1`, `active`, `enrolled_in_year`, ";
	if($enrolled_out_year!=''){
			$studentUpdateQuery.="`enrolled_out_year`,";
			}
