...
$studentQuery = " select sd.name,st.class,st.rte,sd.email_id,sd.aadhaar,sd.father_name,sd.mother_name,sd.address,sd.mob1,sd.enrolled_in_year,sd.enrolled_out_year,sd.previous_attended_school,sd.notes,st.dues,st.paid_upto, sd.active from $studentSession st left join student_detail sd on st.admno = sd.admno where
    sd.admno= '$admno' ";
$student_detail = mysqli_query($conn, $studentQuery);

$studentFamilyQuery = " select st.admno from $studentSession st left join student_detail sd on st.admno = sd.admno where
...
<table  cellpadding="0" cellspacing="0" align="center" width="100%" border="0">
	<tbody>
		...
		<tr>
			...
			<th><p>ENROLLED IN YEAR</p></th>
			<th><p>ENROLLED OUT YEAR </p></th>
